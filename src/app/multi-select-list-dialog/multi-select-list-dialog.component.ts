...
@Component({
    ...
    <div mat-dialog-content>
        <form (submit)="selectFirst()">
            <mat-form-field>
                <input matInput [(ngModel)]="searchString" [ngModelOptions]="{standalone: true}" placeholder="Search" > 
            </mat-form-field>
        </form>
        <mat-nav-list role="list" *ngIf="values">
            <ng-container *ngFor="let o of values">
                <ng-container *ngIf="matchesFilter(o)">
                <mat-list-item role="listitem" style="height:36px" (click)="selectItem(o)">
                <mat-checkbox [checked]="selectedValues.includes(o)"></mat-checkbox> &nbsp;
                    {{getCaption( o)}}
                </mat-list-item>
...
export class MultiSelectListDialogComponent {
    ...
    matchesFilter(o: any) {
        return this.getCaption(o).toLocaleLowerCase().includes(this.searchString.toLocaleLowerCase());
    }
